...
ggsave('Documents/Images/electricity_psf_response.png', width = 6.5, height = 2, units = 'in')
...
p_rfe <- ggplot(data = data.frame(varImp(rfe_train) %>% 
    ...
    theme(axis.text.x = element_text(angle=60, hjust=1),
          ...
          legend.key.height = unit(0.5, "cm"),
          title = element_text(size=14, color = "grey55"))
ggsave(paste0('Documents/Images/electricity_psf_rfe_vars.png'), p_rfe, width = 6.5, height = 3.5, units = 'in')
p_rfe
```
...
p_all_v <- ggplot(data = variable_by_importance_df %>% head(20), 
    ...
    theme(axis.text.x = element_text(angle=60, hjust=1),
          ...
          legend.key.height = unit(0.5, "cm"),
          title = element_text(size=14, color = "grey55"))
ggsave(paste0('Documents/Images/electricity_psf_all_vars.png'), p_all_v, width = 6.5, height = 3.5, units = 'in')
p_all_v
```
