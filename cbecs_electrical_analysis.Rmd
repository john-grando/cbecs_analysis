...
print(pls_train)
varImp(pls_train)
pls_plot <- plot_fun(in_model=pls_train, n_features=7, short_name='pls')
pls_plot$vars_plot
...
print(rf_train)
varImp(rf_train)
rf_plot <- plot_fun(in_model=rf_train, n_features=7, short_name='rf')
rf_plot$vars_plot
...
print(l_train)
varImp(l_train)
l_plot <- plot_fun(in_model=l_train, n_features=5, short_name='l', alt_predict = TRUE)
l_plot$vars_plot
...
print(lp_train)
varImp(lp_train)
lp_plot <- plot_fun(in_model=lp_train, n_features=5, short_name='lp', alt_predict = TRUE)
lp_plot$vars_plot
...
print(nn_train)
varImp(nn_train)
nn_plot <- plot_fun(in_model=nn_train, n_features=5, short_name='nn', alt_predict = TRUE)
nn_plot$vars_plot
