...
#NEED TO SPLIT UP TRAIN/TEST TO TRAIN AND TEST
nn_input_train_test_pba_labels <- cbecs_el_cleaned_df[cbecs_train_list,]$PBA
nn_input_validate_pba_labels <- cbecs_el_cleaned_df[-cbecs_train_list,]$PBA
  
save(nn_input_train_test_pba_labels, 
     nn_input_validate_pba_labels, 
     nn_input_train_test_df, 
     nn_input_validate_df, 
     file='nn_input.RData'
)
```
