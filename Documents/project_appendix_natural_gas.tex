...
\appendix
\subsection{Response}
\label{appendix:natural_gas_psf:response}
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth, height=0.3\textheight]{Images/natural_gas_psf_response.png}
\end{figure}
\subsection{PCA}
\label{appendix:natural_gas_psf:pca}
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth, height=0.3\textheight]{Images/natural_gas_psf_pca_vars.png}
\end{figure}
\FloatBarrier
\newpage
\subsection{PLS}
\label{appendix:natural_gas_psf:pls}
\begin{figure}[h]
\centering
...
\label{appendix:natural_gas_psf:rf}
\begin{figure}[h]
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\label{appendix:natural_gas_psf:lp}
\begin{figure}[h]
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\label{appendix:natural_gas_psf:rfe}
\begin{figure}[h]
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\label{appendix:natural_gas_psf:snn}
\begin{figure}[h]
\centering
\begin{subfigure}{1\textwidth}
\centering
...
\label{appendix:natural_gas_psf:sva}
\begin{figure}[h]
\centering
