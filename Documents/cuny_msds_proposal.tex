...
% --------------------------------------------------------------------
\title{	\Large { CUNY MSDS Capstone Project \\ Proposal} 	% Subtitle
		 	\\[2.0cm]								% 2cm spacing
...
% ------------------------------------------------------------------------------
\noindent
\input{proposal_background}
\\[0.125in]
\input{proposal_preliminary_analysis}
\noindent
\input{proposal_objective_and_deliverable}
\end{document}