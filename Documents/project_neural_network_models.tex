...
The final selected model consisted of a 3 hidden layers of 300 nodes, using a dropout rate of 0.6, no regularization, batch sizes of 50 and XXX variables for selection.  XXX additional points were appended to the training set by adding noise to the numeric column, in an effort to provide more training examples.  The number of variables is greatly reduced while maintaining relativively similar performance
