...
p1 <- ggplot(hyper_summary_best, 
  ...
  geom_line() +
  geom_line(aes(x=num_vars, y=sqrt(mse)/max(sqrt(mse))*1.75, color='RMSE')) +
  scale_y_continuous(sec.axis = sec_axis(~.*max(sqrt(hyper_summary_best$mse))/1.75, name="Root Mean Square Error", breaks = seq(70000, 85000, 5000)), breaks = seq(1.2, 2.0, 0.1)) +
