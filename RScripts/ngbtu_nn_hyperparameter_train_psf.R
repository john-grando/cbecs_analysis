...
if(head_object('ModelSaves/ngbtu_nn_hyperparameter_results_psf.RData', bucket='cuny-msds-final-project-cbecs')[1]==TRUE){
  s3load('ModelSaves/ngbtu_nn_hyperparameter_results_psf.RData', bucket = 'cuny-msds-final-project-cbecs')
}
if(head_object('ModelSaves/ngbtu_nn_hyperparameter_results_psf.RData', bucket='cuny-msds-final-project-cbecs')[1]==FALSE){
...
for(v in c(#seq(0,length(variables_by_importance),300), 
  ...
  model_name <- 'ModelSaves/ngbtu_nn_hyperparameter_results_psf.RData'
